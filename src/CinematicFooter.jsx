...
@keyframes bfooter-heartbeat {
  ...
  15%, 45%  { transform: scale(1.25); filter: drop-shadow(0 0 10px rgba(220,38,38,0.9)); }
...
.bfooter-giant-text {
  ...
  color: transparent;
  -webkit-text-stroke: 1px rgba(220,38,38,0.08);
  background: linear-gradient(180deg, rgba(220,38,38,0.12) 0%, transparent 65%);
  -webkit-background-clip: text;
  background-clip: text;
  user-select: none;
}

/* Metallic red heading glow */
.bfooter-heading-glow {
  background: linear-gradient(160deg, #ffffff 0%, #f87171 50%, #dc2626 100%);
  -webkit-background-clip: text;
...
.bfooter-pill:hover {
  ...
  background: linear-gradient(145deg, rgba(220,38,38,0.08) 0%, rgba(220,38,38,0.03) 100%);
  box-shadow: 0 12px 32px -8px rgba(220,38,38,0.2), inset 0 1px 0 rgba(220,38,38,0.1);
  color: #ffffff;
}

/* Red pill (primary CTA) */
.bfooter-pill-red {
...
.bfooter-pill-red:hover {
  ...
  box-shadow: 0 12px 32px -4px rgba(220,38,38,0.6);
  transform: translateY(-2px) scale(1.03);
}

.bfooter-divider {
  height: 1px;
  background: linear-gradient(to right, transparent, rgba(220,38,38,0.3), rgba(255,255,255,0.06), rgba(220,38,38,0.3), transparent);
}
`;
    ...
    <>
      ...
      >
        <footer className="brillnex-footer-wrapper fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden"
          style={{ backgroundColor: "#0a0a0a", color: "#f3f4f6" }}
        >
          {/* Red aurora glow */}
          ...
          <div className="absolute top-10 left-0 w-full overflow-hidden py-3 z-10 -rotate-[1.5deg] scale-110"
            style={{ borderTop: "1px solid rgba(220,38,38,0.15)", borderBottom: "1px solid rgba(220,38,38,0.15)", backgroundColor: "rgba(10,10,10,0.7)", backdropFilter: "blur(12px)" }}
          >
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <a href="#hero" className="flex flex-col items-start group order-1 md:order-1">
                <div className="text-xl font-black tracking-widest text-white leading-none group-hover:text-red-400 transition-colors">
                  BRILLNE<span className="text-red-600 group-hover:text-white transition-colors">X</span>
                </div>
                <div className="flex items-center gap-1.5 mt-1 opacity-80">
                  <div className="h-px w-3 bg-red-600 group-hover:bg-white transition-colors" />
              ...
              <div className="bfooter-pill px-5 py-2.5 rounded-full flex items-center gap-2 order-2 cursor-default">
                ...
                <span className="animate-bfooter-heartbeat text-red-500 text-base">❤</span>
